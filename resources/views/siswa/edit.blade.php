...
<form action="{{ route('siswa.update', $siswa->id) }}" method="POST">
    ...
    <div class="form-control mb-3">
        ...
        <input type="number" id="nis" name="nis" value="{{ old('nis', $siswa->nis) }}" class="form-control">
        ...
        <input type="text" id="hobi" name="hobi" value="{{ old('hobi', $siswa->hobi) }}" class="form-control"> <!-- Pastikan ini benar -->
    </div>
